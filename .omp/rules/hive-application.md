...
The use-case never imports `sea_orm`. [CQRS](../../docs/adr/0006-cqrs.md)
...
Integration constructs the use-case with this cell's real sea-orm adapter. [Testing](../../docs/adr/0011-testing.md)
